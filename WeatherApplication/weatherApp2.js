...
async function weatherNow() {
    ...
    document.querySelector("#vremea2").innerText = json.main.humidity;
    document.querySelector("#vremea3").innerText = json.main.pressure;
    document.querySelector("#vremea4").innerText = json.main.temp;
